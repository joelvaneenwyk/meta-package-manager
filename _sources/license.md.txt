...
[GNU General Public License v2 or later (GPLv2+)](https://github.com/kdeldycke/meta-package-manager/blob/main/license).
...
- [angry paper box](https://github.com/kdeldycke/meta-package-manager/blob/main/docs/assets/angry-paper-box.svg)
  is sourced from
  [paper box head](https://openclipart.org/detail/300407/paper-box-head)
- [multi-box logo](https://github.com/kdeldycke/meta-package-manager/blob/main/docs/assets/logo-banner.svg)
